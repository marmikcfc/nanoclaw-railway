...
```yaml
- uses: qwibitai/pepper/repo-tokens@v1
  with:
    include: 'src/**/*.ts'
    exclude: 'src/**/*.test.ts'
```
...
| Repo | Badge |
|------|-------|
| [Pepper](https://github.com/qwibitai/Pepper) | ![tokens](https://raw.githubusercontent.com/qwibitai/Pepper/main/repo-tokens/badge.svg) |
