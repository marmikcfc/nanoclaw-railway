...
This skill adds Slack support to Pepper, then walks through interactive setup.
...
```bash
git remote add slack https://github.com/qwibitai/pepper-slack.git
```
...
>
> The JID format for Pepper is: `slack:C0123456789`
...
6. Restart: `launchctl kickstart -k gui/$(id -u)/com.pepper`
