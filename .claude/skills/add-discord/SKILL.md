---
name: add-discord
description: Add Discord bot channel integration to Pepper.
---

# Add Discord Channel

This skill adds Discord support to Pepper, then walks through interactive setup.
...
```bash
git remote add discord https://github.com/qwibitai/pepper-discord.git
```
...
4. Service is running: `launchctl list | grep pepper`
...
- @mention translation (Discord `<@botId>` → Pepper trigger format)
