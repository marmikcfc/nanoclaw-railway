...
<html><head><title>Pepper - WhatsApp Auth</title>
...
<html><head><title>Pepper - Connected!</title>
<style>
...
<script>localStorage.removeItem('pepper_qr_start');</script>
</body></html>`;
