...
Pepper gives you the core functionality without that mess.
...
- Custom `pepper` MCP server (inside container) provides scheduling tools
...
**Pepper** - A reference to Clawdbot (now OpenClaw).
