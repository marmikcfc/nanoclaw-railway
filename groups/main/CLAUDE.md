...
If the user wants to set up an allowlist, edit `~/.config/pepper/sender-allowlist.json` on the host:
...
- The config file is on the host at `~/.config/pepper/sender-allowlist.json`, not inside the container
