...
export const CONTAINER_IMAGE =
  process.env.CONTAINER_IMAGE || 'pepper-agent:latest';
...
// Example: http://pepper.railway.internal:3000
// Only needed by the cron-tick.ts script; not used by the main process.
export const PEPPER_INTERNAL_URL =
  process.env.PEPPER_INTERNAL_URL || '';
